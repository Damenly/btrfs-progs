...
/*
 * During the iteration of the whole fs, original mode will record bad items
 * (from meaningless key to other problems), and delete them using this
 * function.
 */
...
/*
 * Entry point for original mode to check extents and chunks.
 */
...
/*
 * Entry point for original mode to check fs trees
 *
 * @root_cache:	cache_tree with all tree roots.
 */
